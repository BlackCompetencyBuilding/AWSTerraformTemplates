resource "aws_instance" "workernode2" {
  ...
  "sudo curl -k -u servicemesh:SMFY@cce55 'https://ftp-aus.servicemesh.com/csc/solutions/11.0/agility-cli-11.0.1.tar.gz' -o /home/smadmin/agility-cli-11.0.1.tar.gz",

...
resource "aws_instance" "masternode" {
  ...
  "sudo curl -k -u servicemesh:SMFY@cce55 'https://ftp-aus.servicemesh.com/csc/solutions/11.0/agility-images-11.0.1.tar.gz' -o /home/smadmin/agility-images-11.0.1.tar.gz",
  "sudo curl -k -u servicemesh:SMFY@cce55 'https://ftp-aus.servicemesh.com/csc/solutions/11.0/cloud-plugin-images-11.0.1.tar.gz' -o /home/smadmin/cloud-plugin-images-11.0.1.tar.gz",
  "docker swarm init",

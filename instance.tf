...
resource "aws_instance" "masternode" {
  ...
  provisioner "remote-exec" {
	...
	"echo ${var.masternodehostname} > /home/smadmin/masternodehostname",
      "echo 'The actual hostname is...'",
      "hostname",
      "hostnamectl",
      "echo 'Changing the hostname....'",
      "sudo hostnamectl set-hostname $(cat /home/smadmin/masternodehostname)",
  ...
  "sudo curl -k -u <ftp_username>:<ftp_password> 'https://ftp-aus.servicemesh.com/csc/solutions/11.0/agility-images-11.0.1.tar.gz' -o /home/smadmin/agility-images-11.0.1.tar.gz",
  "sudo curl -k -u <ftp_username>:<ftp_password> 'https://ftp-aus.servicemesh.com/csc/solutions/11.0/cloud-plugin-images-11.0.1.tar.gz' -o /home/smadmin/cloud-plugin-images-11.0.1.tar.gz",
  "docker swarm init",
